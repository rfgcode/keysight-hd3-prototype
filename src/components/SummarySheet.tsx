  ...
  return (
    ...
    >
      ...
      <div
        ...
        className={`absolute inset-x-0 bottom-0 mx-auto flex max-h-[85dvh] w-full flex-col items-end rounded-t-lg bg-white pb-12 pt-16 transition-transform duration-300 ease-out ${
